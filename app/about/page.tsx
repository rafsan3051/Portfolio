  ...
  return (
    <div className="relative min-h-screen bg-zinc-950">
      ...
      <nav className="fixed top-0 z-50 w-full border-b border-zinc-800/50 bg-black/50 backdrop-blur-sm">
        <div className="container mx-auto flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/about" className="text-sm duration-500 text-zinc-100 hover:text-zinc-400">
              About
            </Link>
      ...
      <div className="container mx-auto max-w-4xl px-6 pt-32 pb-16">
        ...
        <h1 className="py-3.5 px-0.5 text-4xl md:text-6xl font-bold text-transparent bg-white bg-clip-text animate-title mb-8">
          About Me
        </h1>
